# -*- coding: utf-8 -*-
#
# pytest-reserial documentation build configuration file, created by
...
project = 'pytest-reserial'
copyright = '2015, Alexander Bessman'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', 'pytest-reserial Documentation',
     [author], 1)
]
